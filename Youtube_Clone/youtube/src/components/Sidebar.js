...
import { removeResultVideos } from '../utils/searchSlice';
...
const Sidebar = () => {
  ...
  const hanldeHomeButton = ()=>{
    dispatch(removeResultVideos(null));
    navigate("/");
  }
  if(!isMenuOpen) return null;
  return (
    <div className='w-40 md:w-full p-5 shadow-lg'>
      <ul className='border-b border-slate-200'>

        <h1 className='font-bold p-2 hover:bg-gray-100 flex items-center cursor-pointer rounded-lg active:bg-white'>
          ...
          <button onClick={hanldeHomeButton}>Home</button>
        </h1>

        <li className='p-2 flex cursor-pointer hover:bg-gray-100 rounded-lg'>
          <svg xmlns="http://www.w3.org/2000/svg" 
            height="24" viewBox="0 0 24 24" width="24" focusable="false" 
            className="mr-6"
          >
      ...
      <ul className='border-b border-slate-200'>
        <h1 className='font-bold p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>You</h1>

        <li className='flex p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>
        ...
        <li className=' flex p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>
          <svg xmlns="http://www.w3.org/2000/svg" 
            height="24"viewBox="0 0 24 24" width="24" focusable="false" className='mr-6'
          >
      ...
      <ul className='border-b border-slate-200'>
        ...
        <li className='p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>CNBC</li>
        <li className='p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>English Speeches</li>
        <li className='p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>Being Limitless</li>
        <li className='p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>Think School</li>
      </ul>
      ...
      <ul className='border-b border-slate-200'>
        ...
        <li className='flex p-2 cursor-pointer hover:bg-gray-100 rounded-lg'>
          <svg xmlns="http://www.w3.org/2000/svg" 
            height="24" 
            className="mr-6" viewBox="0 0 24 24" width="24" focusable="false"
          >
