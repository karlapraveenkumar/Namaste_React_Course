                    ...
                    <div className="w-3/12 p-4">
                        <div className="absolute">
                            <button onClick={()=>handleAddItem(item)} 
                                className="mx-12 rounded-lg shadow-lg p-2 bg-green-500 hover:bg-green-700 text-white font-bold focus:outline-none focus:ring-2 focus:ring-pink-600 ring-offset-2"
                            > Add </button>
                        </div>
